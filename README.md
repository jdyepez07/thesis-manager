...
Puerto libre para alojar el backend (por defecto 5000)

Acceso a internet para clonar repositorios Git
...
Asegúrate de que /proyectos exista en tu sistema host:
